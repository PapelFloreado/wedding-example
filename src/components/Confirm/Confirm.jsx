...
const Confirm = () => {
  ...
  return (
    <div className='pt-20 bg-back bg-cover bg-fixed md:bg-fixed'>
        ...
        <div className='text-melon flex-col'>
            ...
            <motion.div initial={{ opacity: 0, scale:0.5 }}
                ...
                animate={{scale: 1}}
                exit={{ opacity: 0}} className='md:flex-row flex flex-col font-roboto py-20 text-4xl items-center justify-center mx-auto'>
                <button className='hover:border-melon flex border-white text-white justify-center gap-5 items-center bg-melon' type='button'>
                    <BsWhatsapp/>
                ...
                <button className='hover:border-melon text-white bg-melon border-white flex justify-center gap-5 items-center' type='button'>
                    <BsWhatsapp />
                    <a className='text-white text-2xl md:text-6xl' href="https://wa.me/5491140435288/?text=Hi!%20I%20liked%20your%20application%20I%20would%20like%20to%20hire%20you" target="_blank" rel="noopener noreferrer">We will accompany you on this special day</a>
                </button>
            </motion.div>
