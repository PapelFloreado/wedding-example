...
const Itinerario = () => {
  ...
  return (
    <div className='  py-20 my-10 bg-melon'>
        <h2 className='text-center font-roboto text-8xl mb-16'>Itinerary</h2>
        <div className='flex justify-around text-center text-4xl'>
            <div className='border-2 p-12 basis-1/4 border-white  hover:scale-125 duration-700 ease-in-out'>
            ...
            <div className='border-2 basis-1/4 border-white p-12 hover:scale-125  duration-700 ease-in-out'>
                <div className='flex justify-center mx-auto mb-6'>
                    <BiChurch/>
                </div>
