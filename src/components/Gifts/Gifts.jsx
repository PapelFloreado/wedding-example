...
const Gifts = () => {
  ...
  return (
    <div className='bg-melon py-20'>
        <h2 className='text-6xl md:text-8xl font-roboto text-center'>Gift Table</h2>
        <p className='text-center text-4xl md:text-6xl mt-10'>Our best gift is that you join us this day.</p>
        <p className='text-center text-4xl md:text-6xl mt-6'>But if you want to have a detail these are the options.</p>
